	...
	public SignupFrame() {
		...
		submit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(firstName.getText().length() < 2 || firstName.getText().length() > 17) {
					errorMessage = "First name must include 2-17 characters";
				}else if(lastName.getText().length() < 2 || lastName.getText().length() > 17) {
					errorMessage = "Last name must include 2-17 characters.";
