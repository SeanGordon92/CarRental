 ...
 * can find between available cars by filtering using dates,, branches, categories, gear, manufacturing year and max price
 * @author Sean & Bar
 *
 */
...
public class UserBookCar extends JFrame  {
	...
	private void init() {
		...
		filterSearch2.add(new JLabel("Manufactured Year:",SwingConstants.CENTER));
