...
public class MainPageFrame extends JFrame {
	...
	public MainPageFrame() {
		...
		exitButt = new JButton("Close Program");
		welcomeMessage = new JLabel("Welcome to Car Rent!",SwingConstants.CENTER);
	...
	private void init() {
		...
		exitButt.setFont(new Font("Verdana", Font.PLAIN, 18));
		exit_flow.add(exitButt);
